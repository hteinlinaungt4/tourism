                ...
                <tr class="tr-shadow">
                    ...
                    <td>
                        <div class="table-data-feature d-flex">
                            ...
                            <a href="{{ route('admin#delete',$user->id) }}" class="btn btn-danger btn-sm ml-1" onclick="return confirm('Are you sure you want to delete this category?')">Delete</a>
                        </div>
                    </td>
                </tr>
                @endforeach
